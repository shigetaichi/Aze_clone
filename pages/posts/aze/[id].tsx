...
import {ContentIndex, Title, Button, PostThumbnail, PostTranslationMenu, CategoryAreaWp, TagArea, PostCategoryAndTags} from '../../../components';
...
export const getStaticProps = async ({params}) => {
  ...
  await Promise.all([
    (async () => {
      postData = await wpGetPostDataById('az', params.id);
    })(),
    (async () => {
      nextAndPrev = await wpGenerateNextAndPrevArray('az', params.id);
    })(),
    (async () => {
